...
namespace SimpleExample
{
    public partial class simpleexample : Form
    {
        ...
        String roll_yaw;
        String altitude;
        private delegate void SetYawAndRoll();
        private SetYawAndRoll setYawAndRollDelagate;
        private delegate void SetAltitude();
        private SetAltitude setAltitudeDelagate;
        bool armed = false;
        ...
        {
            InitializeComponent();
            setYawAndRollDelagate = new SetYawAndRoll(setYawAndRollMethod);//the delagate references the method - D
            setAltitudeDelagate = new SetAltitude(setAltitudeMethod);
        ...
        //method to set yaw and roll amount to the respective label
        private void setYawAndRollMethod() {
            label_att.Text = roll_yaw;

        }
        //method to set altitude amount to the respective label
        private void setAltitudeMethod()
        {
            label_gps.Text = altitude;
        }
