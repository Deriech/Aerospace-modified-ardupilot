...
// square
        ...
        {
            script = new Script(checkBoxRedirectOutput.Checked, dataDisplay);
        ...
        private void scriptChecker_Tick(object sender, EventArgs e)
        {
            if (!scriptrunning)
            {
                ...
                if (!isDataDisplayed) {
                    ...
                    script.dataDisplay = dataDisplay;
            ...
            else if ((script != null) && (checkBoxRedirectOutput.Checked) && (!outputwindowstarted))
            {
                ...
                //dataDisplay = new DataDisplay();
                //script.dataDisplay = dataDisplay;
                //Added DataDisplay Object for DAS - Welsey/Deriech
                //Removed DataDisplay from here because it wasn't visible to ironpython
                //added isDataDisplayed to check if the DAS was already recreated
                //if (!isDataDisplayed) {
                //    dataDisplay = new DataDisplay();
                //    script.dataDisplay = dataDisplay;
                //    isDataDisplayed = true;
